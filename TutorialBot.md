...
`setup` is useful for running one time code that creates configures Arduino pins so we can do things like add an LED or attach a Servo motor. For example, if we attach 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjExNTY2Mzg2NCw5NTMwNjA3NzMsMTk0Mz
